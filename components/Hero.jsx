...
const Hero = () => {
  const handleDownloadCV = () => {
    const cvFilePath = '/my-cv.pdf'; //  your CV file path in the public folder
    const cvFileName = 'Emmanuel Tokula CV'; //  your desired filename
        ...
        <div className="flex justify-between gap-x-8">
          ...
          <div className="flex max-w--[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
            <div className="text-sm uppercase font-semibold mb-4 text-primary tracking-[4px]">
              Frontend Developer <br /> Creative Director
            </div>
            <h1 className="mb-4 h1">
              Hello, My Name is <br /> Emmanuel Tokula
            </h1>
          ...
          <div className="relative hidden xl:flex">
            {/* badge */}
            <Badge containStyles="absolute top-[24%] -left-[5rem]" icon={<RiBriefcase4Fill />} endCountNum={3} badgeText="Year of Experience" />
            {/* badge2 */}
            <Badge containStyles="absolute top-[80%] -left-[1rem]" icon={<RiTodoFill />} endCountNum={50} endCountText="+" badgeText="Finished Project" />
            {/* badge 3 */}
            <Badge containStyles="absolute top-[55%] -right-8" icon={<RiTeamFill />} endCountNum={100} endCountText="h" badgeText="Happy Clients" />
